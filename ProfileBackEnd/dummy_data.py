...
class DummyDataModel:
    dummy_data = {
        ...
        "sexual_orientation": ["straight", "gay", "bi", "pansexual", "asexual"],
        ...
        "profile_questions": {
            ...
            "favorite_activity": ["basketball", "soccer"],
            "favorite_food": ["ice cream", "tacos"],
            "top_places": ["hawaii", "LA"],
        },
    }

    def random_profile(self):
        first_name = random.choice(self.dummy_data["first_names"])
        last_name = random.choice(self.dummy_data["last_names"])
